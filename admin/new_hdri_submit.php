...
$fileformat = mysqli_real_escape_string($conn, $_GET["fileformat"]);
$slug = $_GET["slug"];
...
$sql_fields['whitebalance'] = $_GET["whitebalance"];
...
$dr_d_shutter = $_GET['dr_d_shutter'];
$dr_l_shutter = $_GET['dr_l_shutter'];
...
$dr_aperture = log($_GET['dr_d_aperture']/$_GET['dr_l_aperture'], 1.41421);
$dr_iso = log($_GET['dr_l_iso']/$_GET['dr_d_iso'], 2);
$dr_filter = $_GET['dr_d_filter'] - $_GET['dr_l_filter'];
